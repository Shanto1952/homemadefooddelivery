...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        // Register user
        $result = registerUser($name, $email, $phone, $address, $password, 'customer');
        ...
        if ($result['success']) {
            ...
            $successMessage = "Registration successful! Please check your email for verification code. For development: $verificationCode";
